...
X=as.matrix(dat[,-c(5,48,2,47,45,43)])
...
# 
fit.second = glmnet.PGD.cv(Xs, Ys, kappa, lambda.second.range, L1bound, beta.initial, tol = 10^(-4), rate = 0.01)
...
write.csv(result, file = "mcs8.csv")
#write.csv(result, file = "pcs8.csv")
